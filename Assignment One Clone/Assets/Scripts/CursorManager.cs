...
public class CursorManager : MonoBehaviour
{
    ...
    public event EventHandler<OnCursorLockedChangedEventArgs> OnCursorLockedChanged;
    ...
    public class OnCursorLockedChangedEventArgs : EventArgs
    {
    ...
    public void SetCursorLocked(bool locked)
    {
        ...
        OnCursorLockedChanged?.Invoke(this, new OnCursorLockedChangedEventArgs { isCursorLocked = locked });
    }
